  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the convenience of B2C Car Sharing - Book cars near you, effortlessly managed by our dedicated operations staff from centralized dashboards."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the convenience of B2C Car Sharing - Book cars near you, effortlessly managed by our dedicated operations staff from centralized dashboards.`}
            </Text>
            <Box
